...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(sinaWeiboActionSheetDidClick:selectedItem:)]) {
        [self.delegate sinaWeiboActionSheetDidClick:self selectedItem:indexPath.row];
    }
